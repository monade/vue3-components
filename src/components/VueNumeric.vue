...
export default defineComponent({
  ...
  watch: {
    ...
    readOnly (newValue: boolean, oldValue: boolean) {
      if (oldValue === false && newValue === true) {
        this.$nextTick(() => {
          (this.$refs.readOnly as HTMLSpanElement).className = this.readOnlyClass
        })
      }
    },
  ...
  mounted () {
    ...
    if (this.readOnly) (this.$refs.readOnly as HTMLSpanElement).className = this.readOnlyClass
  },
